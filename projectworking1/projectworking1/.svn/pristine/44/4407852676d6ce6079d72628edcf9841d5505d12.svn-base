...
Post::Post(std::string input, User user)
{
    if(input != ""  && input.length() < 1000)
    {
        ...
        type_ = -1;
        error_ = "The Post is empty or too long.";
    }
}

Post::Post(std::string input, int type, User user){
...
std::string Post::contain(std::string search){
